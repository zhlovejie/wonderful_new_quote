...
// index/dashboard
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: PageView,
        meta: { title: '考勤管理', icon: 'bell', permission: ['permission'] },
        redirect: '/canteen-menu-management/config',
        children:[
          {
            ...
            meta: { title: '考勤规则设置', icon: 'setting', keepAlive: false, permission: ['permission'] },
            children:[
              {
                ...
                meta: { title: '班次设置', icon: 'setting', keepAlive: false, permission: ['permission'] }
              },
              {
                ...
                meta: { title: '补卡规则设置', icon: 'setting', keepAlive: false, permission: ['permission'] }
              },
              {
                ...
                meta: { title: '加班规则设置', icon: 'setting', keepAlive: false, permission: ['permission'] }
              },
              {
              ...
              },
              {
                ...
                meta: { title: '假期规则设置', icon: 'setting', keepAlive: false, permission: ['permission'] }
              },
              {
                ...
                meta: { title: '节假日管理', icon: 'setting', keepAlive: false, permission: ['permission'] }
              }
            ]
          },
          {
            ...
            meta: { title: '出差申请', icon: 'car', keepAlive: false, permission: ['permission'] },
          },
          {
            ...
            meta: { title: '加班申请', icon: 'setting', keepAlive: false, permission: ['permission'] },
          },
          {
          ...
          },
          {
            ...
            meta: { title: '补卡申请', icon: 'setting', keepAlive: false, permission: ['permission'] },
          },
          {
            ...
            meta: { title: '请假申请', icon: 'setting', keepAlive: false, permission: ['permission'] },
          },
          {
            ...
            meta: { title: '人脸打卡记录', icon: 'setting', keepAlive: false, permission: ['permission'] },
          },
          {
            ...
            meta: { title: '考勤报表', icon: 'line-chart', keepAlive: false, permission: ['permission'] },
            children:[
              {
      ...
      },
      {
        ...
        component:PageView,
        meta:{title:'物联网卡管理', icon: 'setting', permission: ['permission']},
        redirect: '/canteen-menu-management/config',
        children:[{
          path: '/icotcard-management/mycard',
          name: 'icotcard-management-mycard',
          component: () => import('@/views/icotcard-management/mycard/List'),
          meta: { title: '我的卡片', icon: 'setting', keepAlive: false, permission: ['permission'] },
        }]
      },
      {
        //研发管理
        ...
        children:[
          {
            ...
            component: RouteView,
            meta: { title: '图纸管理', icon: 'select', keepAlive: false, permission: ['permission'] },
            children: [
              {
                ...
                meta: { title: '图纸权限', icon: 'setting', keepAlive: false, permission: ['permission'] },
              },
              {
                ...
                meta: { title: '图纸管理', icon: 'profile', keepAlive: false, permission: ['permission'] },
              }
            ]
          }
        ]
