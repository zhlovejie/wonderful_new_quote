      ...
      <div class="box">
        <div class="selector">
          <span>
            ...
            <select class="year">
              <option v-for="val in 201" :key="val" :value="val+1899">{{val+1899}}年</option>
            </select>
          ...
          <span>
            ...
            <select class="month">
              <option v-for="val in 12" :key="val" :value="val">{{val}}月</option>
            </select>
...
export default {
  ...
  methods:{
    ...
    init(){
      let that = this
      var $mod_calendar = document.querySelector('.mod-calendar')
      var $table = $mod_calendar.querySelector('.table')
      var $year = $mod_calendar.querySelector('.year')
      var $month = $mod_calendar.querySelector('.month')
      var $holiday = $mod_calendar.querySelector('.holiday')
      var $goback = $mod_calendar.querySelector('.goback')
      var $prev_year = $mod_calendar.querySelector('.prev-year')
      var $next_year = $mod_calendar.querySelector('.next-year')
      var $prev_month = $mod_calendar.querySelector('.prev-month')
      var $next_month = $mod_calendar.querySelector('.next-month')
      var $info = $mod_calendar.querySelector('.info')
      var _data = [];
      var _day = 1;
      var holiday = {
        '2011': [{
...
.mod-calendar input,textarea,select{font-family:inherit;font-size:inherit;font-weight:inherit;*font-size:100%}
.mod-calendar{
	font-size: 14px;
	font-family: Arial,Helvetica,"Microsoft Yahei";
}
.mod-calendar button, input {
    font-family: Arial,Helvetica,"Microsoft Yahei";
}
.mod-calendar img{
...
.mod-calendar .clearfix:before, .clearfix:after {
	content:"";
	display:table;
}
.mod-calendar .clearfix:after{
	clear:both;
	overflow:hidden;
}
.mod-calendar .clearfix{
	zoom:1;
}
.mod-calendar{
	position: relative;
