                  ...
                  <td colspan="7">
                    <a-form-item>
                      <a-input-number
                        ...
                        :precision="2"
                        placeholder="运费"
                        v-decorator="['freightCharge', { rules: [{ required: true, message: '请输入运费!' }] }]"
                      />
                    </a-form-item>
                  </td>
                </tr>
...
export default {
  ...
  methods: {
    ...
    goBackPricing() {
      ...
      this.$destroy('distribution_InvoiceApproval')
    },
    handleOk(e) {
      const _this = this
