      ...
      <a-row :gutter="0">
        ...
        <a-col :span="12">
          <a-form-item label="优先级">
            <a-select v-decorator="['emergenceLevel']" placeholder="优先级" :allowClear="true">
        ...
        <a-col :span="12">
          <a-form-item label="检验类型">
            <a-select v-decorator="['checkType']" placeholder="检验类型" :allowClear="true">
              <a-select-option :value="1">半成品检验</a-select-option>
              <a-select-option :value="2">成品检验</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="收料仓库">
            <a-select v-decorator="['storageId']" placeholder="收料仓库" :allowClear="true">
