        ...
        <table class="custom-table custom-table-border">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a-form-model-item>
                  {{ CheckDetail.scrapDepartmentName }}
                </a-form-model-item>
              </td>
              <td style="width: 150px">
                <span>报检人</span>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  >
                    <a-radio-group v-model="form.checkResult">
                      <a-radio :value="1">返修</a-radio>
                      <a-radio :value="2">报废</a-radio>
                      <a-radio :value="3">再利用</a-radio>
                    </a-radio-group>
                  </a-form-model-item>
                </td>
              </tr>
...
import { quality_scrap_getCheckDetail, quality_scrap_dealCheck } from '@/api/qualityTesting'
...
export default {
  ...
  methods: {
    ...
    query(type, record = {}, test) {
      ...
      quality_scrap_getCheckDetail({ checkId: record.id }).then((res) => {
    ...
    handleSubmit(operationType) {
      ...
      that.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          ...
          console.log(params)
          quality_scrap_dealCheck(params)
            .then((res) => {
              that.spinning = false
