      ...
      <a-row :gutter="0">
        ...
        <a-col :span="12">
          <a-form-item label="订单编号">
            <a-input v-decorator="['orderNum']" placeholder="根据订单编号模糊查询" :allowClear="true" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="合同编号">
            <a-input v-decorator="['contractNum']" placeholder="根据合同编号模糊查询" :allowClear="true" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
export default {
  ...
  methods: {
    query(tabKey) {
      ...
      this.visible = true
      getAllContractSalesman().then((res) => (this.saleUser = res.data))
    },
    handleCancel() {
      this.visible = false
    },
