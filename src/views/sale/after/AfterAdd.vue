                ...
                <td class="txt-left">
                  <a-form-item>
                    <a-input
                      ...
                      v-decorator="[ 'contractNum' ,{rules: [{ required: true, message: '请选择合同编号/赠送单编号', whitespace: true}]} ]"
                    />
                  </a-form-item>
                </td>
              </tr>
                ...
                <td colspan="3" class="txt-left">
                  <a-form-item>
                    ...
                    >
                      <a-select-option
                        :key="val.id"
                        v-for="val in invoiceList"
                        :value="String(val.id)"
                      >{{ String(val.invoiceNum)}}</a-select-option>
                    </a-select>
                  </a-form-item>
                </td>
              </tr>
                ...
                <tr>
                  ...
                  <td class="txt-left">
                    <a-form-item>
                      <a-radio-group
                        class="wdf-xyk"
                        v-decorator="['aftersaleType',{initialValue: 2}]"
                      >
                  ...
                  <td class="txt-left">
                    <a-form-item>
                      <a-input
                        class="wdf-xyk"
                        style="border:1px solid #ddd;"
                        v-decorator="[ 'platformAccount' ,{rules: [{ required: true, message: '请输入平台账号', whitespace: true}]}]"
                      />
                    </a-form-item>
                  </td>
                  <td>密码</td>
                  <td class="txt-left">
                    <a-form-item>
                      <a-input
                        class="wdf-xyk"
                        style="border:1px solid #ddd;"
                        v-decorator="[ 'platformPassword',{rules: [{ required: true, message: '请输入平台密码', whitespace: true}]}]"
                      />
                    </a-form-item>
                  </td>
                </tr>
...
<script>
import { afterSave, goAdd, listInvoiceByContractId, invoiceDetailById, listInvoiceByPresentId } from '@/api/after'
  ...
  methods: {
    ...
    fillPresentOrder(data) {
      ...
      presentOrderDetail({ presentId: data.id }).then(res => {
        ...
        that.form.setFieldsValue({ customerId: _data.customerId })
