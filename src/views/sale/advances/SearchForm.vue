  ...
  >
    <a-form :form="form" class="search-form-wrapper">
      <a-row :gutter="0">
        ...
        <a-col :span="12">
          <a-form-item label="预收款编号">
            <a-input v-decorator="['advancesCode']" placeholder="预收款编号" :allowClear="true" />
          </a-form-item>
        </a-col>
        <a-col :span="12" v-if="isShowApproveStatus">
          <a-form-item label="单据状态">
            <a-select v-decorator="['approveStatus']" placeholder="单据状态" :allowClear="true">
        ...
        <a-col :span="12">
          <a-form-item label="结算方式">
            <a-select v-decorator="['bankId']" placeholder="选择结算方式" :allowClear="true">
