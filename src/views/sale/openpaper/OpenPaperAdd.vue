      ...
      <a-form :form="form" class="form">
        <a-form-item hidden>
          ...
          <a-row type="flex">
            ...
            <a-col class="col-border" :span="9" justify="center" align="middle">
              <a-form-item>
              <a-radio-group class="wdf-xyk"  :disabled="queryBoolean" v-decorator="['paperType', {initialValue:2}]">
  ...
  methods: {
    ...
    arrearsMoneyChange(e){
      ...
      if(number > maxArrearsMoney){
        this.$message.warn(`欠款金额不能大于 总金额 减去 已付金额，可输入的最大欠款金额为：${Number(maxArrearsMoney).toFixed(2)}`)
      }
    },
