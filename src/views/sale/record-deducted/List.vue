...
<script>
import {
  qualificationBorrowPerformanceDeductionDelete,
  qualificationBorrowPerformanceDeductionRevocation,
  qualificationBorrowPerformanceDeductionPageList,
} from '@/api/receipt'
  ...
  watch: {
    $route: {
      handler: function (to, from) {
        if (to.name === 'sale-record-deducted-list') {
          this.init()
        }
      },
      immediate: true,
