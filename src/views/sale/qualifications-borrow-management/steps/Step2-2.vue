<template>
    ...
    <a-spin :spinning="spinning">
      ...
      <a-modal
        ...
        @cancel="handleCancel"
      >
        <PreviewBusinessBorrowing :contractId="detail.id"/>
      </a-modal>
    </a-spin>

</template>
<script>
import { businessDetailBorrowId, businessaddOrUpdate, generateProtocolNum } from '@/api/agencyContract'
...
import PreviewBusinessBorrowing from '../contractView/previewBusinessBorrowing'
...
export default {
  name: 'addForm',
  components: { ProvinceTreeCascade, CustomerSelect ,PreviewBusinessBorrowing},
  data() {
    return {
      form: this.$form.createForm(this,{name:'qualifications-borrow-management-step2-2'}),
      visible: false,
      spinning: false,
      actionType: 'view',
      detail: {},
  ...
  methods: {
    ...
    async query(type, record={},fillData={}) {
      ...
      await businessDetailBorrowId(param).then((res) => {
