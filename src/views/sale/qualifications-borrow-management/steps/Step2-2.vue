<template>
  <a-spin :spinning="spinning">
    ...
    <div v-if="isAdd" style="margin: 20px 0;text-align: center;">
...
<script>
import { businessdetail, businessaddOrUpdate } from '@/api/agencyContract'
...
export default {
  ...
  methods: {
    ...
    async query(type, record) {
      ...
      await businessdetail(param).then((res) => {
