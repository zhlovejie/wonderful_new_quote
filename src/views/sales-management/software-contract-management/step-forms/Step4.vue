      ...
      <table class="custom-table custom-table-border">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <p>
                合同签署２个工作日内向甲方支付本合同费用40％款项应付金额
                <span class="underline">{{ payPriceA | moneyFormatNumber }}</span> 元
              </p>
              <p>
                部署实施２个工作日内向甲方支付本合同费用40％款项应付金额
                <span class="underline">{{ payPriceB | moneyFormatNumber }}</span> 元
              </p>
              <p>
                交付、验收完毕后3个工作日内向甲方支付本合同剩余费用应付金额
                <span class="underline">{{ payPriceC | moneyFormatNumber }}</span> 元
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <p>
                甲方应于本合同签署并确认收到乙方提供的运行环境后
                <a-form-item
                  ><a-input
                    type="text"
                    :disabled="this.$parent.routeParams.action === 'see'"
                    style="text-align: center"
                    v-decorator="['deliveryDay', { rules: [{ required: true, message: '请输入交付天数' }] }]"
                /></a-form-item>
                天内向乙方完成交付
              </p>
              <p>
                ...
                <a-form-item
                  ><a-input
                    ...
                    v-decorator="[
                      'classfiyDay',
                      { initialValue: 3, rules: [{ required: true, message: '请输入甲方承诺问题技术处理允许天数' }] },
                    ]"
                /></a-form-item>
              ...
              <p>
                ...
                <a-form-item
                  ><a-input
                    ...
                    v-decorator="[
                      'defendYear',
                      { initialValue: 1, rules: [{ required: true, message: '请输入甲方承诺维护周期' }] },
                    ]"
                /></a-form-item>
                ...
                <a-form-item
                  ><a-input
                    ...
                    v-decorator="[
                      'defendPayDesc',
                      {
                        initialValue: '每年按照合同费用的15%收取维护费用',
                        rules: [{ required: true, message: '请输入维护费用说明' }],
                      },
                    ]"
                /></a-form-item>
                。服务器、带宽、微信等第三方费用由乙方自行承担。
              </p>
            </td>
          </tr>
          <tr>
                  ...
                  <p>
                    ...
                    <a-form-item
                      ><a-input
                        type="text"
                        :disabled="this.$parent.routeParams.action === 'see'"
                        v-decorator="['receiveName', { rules: [{ required: true, message: '请输入姓名' }] }]"
                    /></a-form-item>
                  </p>
                </a-col>
                <a-col :span="12">
                  <p>
                    ...
                    <a-form-item
                      ><a-input
                        type="text"
                        :disabled="this.$parent.routeParams.action === 'see'"
                        v-decorator="['receiveTel', { rules: [{ required: true, message: '请输入电话' }] }]"
                    /></a-form-item>
                  </p>
                </a-col>
                <a-col :span="12">
                  <p>
                    ...
                    <a-form-item
                      ><a-input
                        type="text"
                        :disabled="this.$parent.routeParams.action === 'see'"
                        v-decorator="['receiveWx', { rules: [{ required: true, message: '请输入微信号' }] }]"
                    /></a-form-item>
                  </p>
                </a-col>
                <a-col :span="12">
                  <p>
                    ...
                    <a-form-item
                      ><a-input
                        type="text"
                        :disabled="this.$parent.routeParams.action === 'see'"
                        v-decorator="['receiveMail', { rules: [{ required: true, message: '请输入邮箱' }] }]"
                    /></a-form-item>
                  </p>
                </a-col>
              </a-row>
