  ...
  <div class="wdf-custom-wrapper" id="agency-contract-wrapper">
    <div class="search-wrapper">
      <a-form layout="inline">
        ...
        <a-form-item>
          <a-select placeholder="销售人员" v-model="searchParam.saleUserId" style="width: 150px" :allowClear="true">
    ...
    <div class="main-wrapper">
      ...
      >
        ...
        <div class="action-btns" slot="action" slot-scope="text, record">
          <template v-if="+activeKey === 2 || activeKey === 0">
            <a type="primary" @click="doAction('see', record)">查看</a>
          </template>
