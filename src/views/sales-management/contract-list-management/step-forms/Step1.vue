      ...
      >
        ...
        >
          <a-row type="flex">
            ...
            <a-col class="col-border" :span="9" justify="center" align="middle">
              <a-radio-group @change="selectedTax" :disabled="this.$parent.routeParams.action === 'split'" v-decorator="['isTax',{initialValue: 1}]">
                <a-radio :value="1">
                  含税（销售合同）
                </a-radio>
                <a-radio :value="0">
        ...
        >
          <a-row type="flex">
            ...
            <a-col class="col-border" :span="9" justify="center" align="middle">
              <a-radio-group @change="isContractAttribute" :disabled="this.$parent.routeParams.action === 'split'" v-decorator="['contractAttribute',{initialValue: 0}]">
                <a-radio :value="0">
                  我方合同
                </a-radio>
                <a-radio :value="1">
        ...
        <a-form-item>
          <a-row type="flex">
            ...
            <a-col class="col-border" :span="9" type="flex" justify="left" align="middle">
              <!-- 修改和拆分合同不允许修改 是否全款选项 ，会影响后边合同的操作 -->
              <a-radio-group :disabled="this.$parent.routeParams.action !== 'add'" @change="isFullAmount" v-decorator="['fullAmount',{initialValue: 0}]">
                <a-radio :value="0">
                  是
                </a-radio>
                <a-radio :value="1">
            ...
            <a-col class="col-border" :span="3" justify="center" align="middle">
              合同类别
            </a-col>
            <a-col class="col-border" :span="9" type="flex" justify="left" align="middle">
              <a-radio-group v-decorator="['bucketType',{initialValue: 1}]">
        ...
        <a-form-item >
          ...
          <a-col class="col-border" :span="9" type="flex" justify="left" align="middle">
            <a-radio-group @change="freightTypeChange" v-decorator="['freightType',{initialValue: 0}]">
              <a-radio :value="0">
                含运费
              </a-radio>
              <a-radio :value="1">
        ...
        <a-form-item :style="{borderBottom:'1px solid #ddd'}">
          <a-row type="flex" v-if="parseInt(freightType) === 0">
            ...
            <a-col class="col-border" :span="9" type="flex" justify="left" align="middle">
              <a-input-number style="width:60%;"  :min="0" :step="1" :precision="0" placeholder="运费" v-decorator="['freightCharge']" />
            </a-col>
            <a-col class="col-border" :span="3" justify="center" align="middle">
              运费分配类型
            </a-col>
