    ...
    <a-form>
      ...
      >
        ...
        <template slot="productType" slot-scope="text, record">
          <a-select :value="record.productType" placeholder="选择产品类别" @change="typeSelectChange(record, $event)">
        ...
        <template slot="company" slot-scope="text, record">
          <a-select :value="record.company" placeholder="选择单位" @change="companySelectChange(record, $event)">
