<template>
  <div class="content-wrap">
    ...
    <div class="content">
      ...
      <step7 v-if="currentTab === 6" ref="step7" key="step7" @prevStep="prevStep" @finish="finish" :queryonedata="queryonedata" />
    </div>
...
export default {
  ...
  beforeRouteLeave (to, from ,next){
    ...
    try{
      if(from.name === 'basicInformation1' && !this.__isFinished){
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          if(_this.queryonedata && _this.queryonedata.id){
            ...
            }else if(_this.routeParams.action === 'split'){ //拆分修改
              params.contractModifyFlag = 1
            }
