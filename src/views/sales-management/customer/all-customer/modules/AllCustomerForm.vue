    ...
    <a-row class="form-row" :gutter="24">
      <a-col :lg="12" :md="12" :sm="24">
        <a-form-item label="客户名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input @blur="checkName()" placeholder="请输入客户名称" v-decorator="['name',{rules: [{required: true, min: 2, message: '客户名称最少为2个字符！'}]}]"/>
        </a-form-item>
      </a-col>
      <a-col :lg="12" :md="12" :sm="24">
      ...
      <a-col :lg="24" :md="24" :sm="24">
        <a-form-item label="感兴趣产品" :labelCol="oneLBCol" :wrapperCol="oneWPCol">
          <a-checkbox-group v-decorator="['products',{rules: [{required: true, message: '请选择感兴趣产品！'}]}]">
            <a-checkbox :key="pType.text" v-for="pType in productTypes" :value="pType.text">{{ pType.text }}</a-checkbox>
          </a-checkbox-group>
        </a-form-item>
      </a-col>
    </a-row>
