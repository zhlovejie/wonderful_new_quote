<template>
  ...
  <div class="customer_delay_record-list-wrapper">
    <div class="search-wrapper">
      ...
      >
        <a-select-option v-for="item in saleUserSelectDataSource" :value="item.userId" :key="item.userId"
          >{{ item.salesmanName }}
        </a-select-option>
      </a-select>
    ...
    <div class="main-wrapper">
      ...
      >
        ...
        <div slot="action" slot-scope="text, record, index">
          <a @click="showModal(record.evidenceUrl)">查看凭证</a>
        </div>
      </a-table>
    </div>
...
import XdocView from './modules/XdocView'
...
export default {
  ...
  methods: {
    ...
    searchAction(opt) {
      ...
      that.loading = true
      listCustomerDelayRecord(_searchParam)
        .then((res) => {
          that.loading = false
