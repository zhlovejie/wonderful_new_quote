  ...
  <page-view :title="title">
    <a-card :bordered="false">
      ...
      <detail-list title="用户信息">
        <detail-list-item term="用户姓名">张小明</detail-list-item>
        <detail-list-item term="联系电话">18100000000</detail-list-item>
        <detail-list-item term="常用快递">菜鸟仓储</detail-list-item>
        <detail-list-item term="取货地址">江苏省徐州市泉山区湖西路LD-01栋</detail-list-item>
        <detail-list-item term="备注">无，用户是个女汉子，需要快递小妹妹寄件。</detail-list-item>
      </detail-list>
      <a-divider style="margin-bottom: 32px"/>
