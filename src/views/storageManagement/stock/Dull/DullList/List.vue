  ...
  <a-card :bordered="false">
    ...
    <div class="description-document-search-wrapper">
      <a-form layout="inline">
        ...
        <a-form-item>
          <a-input v-model.trim="queryParam.positionCode" allowClear placeholder="仓位代码" style="width: 180px" />
        </a-form-item>
        <a-form-item>
        ...
        <template>
          ...
          <a-form-item>
            <a-button type="primary" @click="outPort()">下载</a-button>
          </a-form-item>
        </template>
      </a-form>
    </div>
...
export default {
  ...
  methods: {
    ...
    searchAction(opt) {
      ...
      that.loading = true
      sluggishgetListByPage(_searchParam)
        .then((res) => {
          that.loading = false
