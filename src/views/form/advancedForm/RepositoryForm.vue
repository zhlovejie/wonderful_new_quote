      ...
      <a-col :xl="{span: 9, offset: 1}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
        <a-form-item
          ...
          <a-select placeholder="请选择管理员" v-decorator="[ 'owner', {rules: [{ required: true, message: '请选择管理员'}]} ]">
            <a-select-option value="小明同学">小明同学</a-select-option>
            <a-select-option value="小翠同学">小翠同学</a-select-option>
            <a-select-option value="小震同学">小震同学</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
    </a-row>
      ...
      <a-col :lg="6" :md="12" :sm="24">
        <a-form-item
          ...
          <a-select placeholder="请选择审批员" v-decorator="[ 'approver', {rules: [{ required: true, message: '请选择审批员'}]} ]">
            <a-select-option value="毛家亮">毛家亮</a-select-option>
            <a-select-option value="唐唐">唐唐</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
      <a-col :xl="{span: 7, offset: 1}" :lg="{span: 8}" :md="{span: 12}" :sm="24">
