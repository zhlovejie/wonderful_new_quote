      ...
      <a-form :form="form">
        <a-form-item label="上级菜单">
          <a-tree-select
            ...
            show-search 
            allow-clear 
            v-decorator="['parentId', { initialValue: detail.parentId,rules: [{ required: true, message: '请选择上级菜单' }] }]"
        ...
        <a-form-item label="名称">
          <a-input
            placeholder="名称"
            v-decorator="['ruleName', {initialValue: detail.ruleName, rules: [{ required: true, message: '请输入名称' }] }]"
           />
        </a-form-item>  
      </a-form>
    </a-spin>
