...
export default {
  ...
  watch: {
    $route: {
      handler: function(to, from) {
        if (to.name === 'after-sales-management_return-goods_receives-customer') {
          this.search()
        }
      },
      immediate: true
  ...
  methods: {
    search(params = {}) {
      ...
      receiveCustomerPageList(_searchParam)
        .then(res => {
          that.loading = false
