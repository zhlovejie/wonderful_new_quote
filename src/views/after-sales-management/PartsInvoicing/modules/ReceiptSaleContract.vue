...
import { accessoriesgetListByPage } from '@/api/after-sales-management'
...
export default {
  ...
  data() {
    return {
      ...
      loadData: (parameter) => {
        return accessoriesgetListByPage(Object.assign(parameter, { status: 2, searchStatus: 0 }, this.queryParam)).then(
          (res) => {
            return res
          }
        )
