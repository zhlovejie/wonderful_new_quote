<template>
  ...
  <div class="wdf-custom-wrapper">
    <div class="search-wrapper">
      ...
      <a-button style="float:right;" type="primary" icon="plus" @click="doAction('add',null)"  v-if="$auth('salary-subsidy-engineer-rules:add')">新增</a-button>
    </div>
...
export default {
  ...
  methods:{
    ...
    searchAction(opt = {}){
      ...
      that.loading = true
      levelRulePageList(_searchParam).then(res => {
        that.loading = false
