<template>
  ...
  <div class="container-list-wrapper">
    <div class="search-wrapper">
      ...
      <a-button class="a-button" :loading="btnDownloadLoading" v-if="$auth('salaryDevelopmentRealityPercentageHis:download')" type="primary" icon="download" @click="doAction('download')">下载</a-button>
    </div>
...
import { developmentRealityPercentageHisList ,exportExcelDatas} from '@/api/commissionDetail'
...
export default {
  ...
  methods: {
    ...
    downloadAction() {
      ...
      exportExcelDatas(3, that.getSearchParams())
        .then((res) => {
