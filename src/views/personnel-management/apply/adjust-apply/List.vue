<template>
  ...
  <div class="adjust-apply-list-wrapper">
    <div class="search-wrapper">
      <a-input placeholder="员工名称模糊查询" v-model="person_name" allowClear style="width: 200px;margin-right:10px;"/>
      <a-select placeholder="选择状态" v-model="operation_status" :allowClear="true" style="width: 200px;margin-right:10px;">
...
export default {
  ...
  methods:{
    ...
    searchAction(opt){
      ...
      that.loading = true
      getPositionApplyListByPage(_searchParam).then(res => {
        that.loading = false
