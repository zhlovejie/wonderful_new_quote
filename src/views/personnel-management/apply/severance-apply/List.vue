<template>
  ...
  <div class="severance-apply-list-wrapper">
    <div class="search-wrapper">
      ...
      <a-select placeholder="选择岗位" :allowClear="true" v-model="stationId" style="width: 200px">
        <a-select-option v-for="item in postSelectDataSource" :key="item.id" :value="item.id">
          {{ item.stationName }}
        </a-select-option>
      </a-select>
      <a-select placeholder="离职类别" :allowClear="true" v-model="operation_type" style="width: 120px">
      ...
      <a-select placeholder="处理状态" :allowClear="true" v-model="operation_status" style="width: 120px">
      ...
      >
      <a
        href="https://www.delanshi.cn/images/cloud/20200409/交接单2dcdff6c-88a7-484d-9e8a-2e59db9940c8.docx"
        class="a-button ant-btn ant-btn-primary"
        target="_blank"
        >下载交接单模板</a
      >
