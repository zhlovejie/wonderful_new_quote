<template>
  ...
  <div class="recruit-apply-list-wrapper">
    <div class="search-wrapper">
      ...
      <a-button class="a-button" v-if="$auth('recruitApply:add')" style="float:right;" type="primary" icon="plus" @click="doAction('add',null)">新增</a-button>
    </div>
      ...
      >
        ...
        <div class="action-btns" slot="action" slot-scope="text, record">
          <template v-if="activeKey === 0">
            ...
            <a-divider type="vertical" v-if="record.status === 2 && record.showModifyButtonFlag === 1" />
            <a type="primary" v-if="record.status === 2 && $auth('recruitApply:edit') && record.showModifyButtonFlag === 1" @click="doAction('edit',record)">修改</a>
          </template>
...
export default {
  ...
  methods:{
    ...
    searchAction(opt){
      ...
      that.loading = true
      pageList(_searchParam).then(res => {
        that.loading = false
