      ...
      <div class="severance-agreement-wrapper">
        ...
        <a-row>
          <a-col :span="24">
            ...
            <p>
              乙方承诺：<br />
              1.离职后乙方不得向任何第三方透漏甲方的商业信息以及技术资料，乙方需将甲方所有商业信息以及技术资料如实交接于甲方并形成书面记录。乙方离职后如接到相关客户需求需转交甲方处理接洽，乙方不再参与甲方任何业务对接。本协议一经签订，乙方与甲方无任何劳务及补偿纠纷。
              <br />
              2.若乙方违反上述承诺，经甲方确认属实的，甲方有权向乙方提出补贴金额五倍的违约金，并追究其相应的法律责任。
            </p>
