  ...
  <a-card :bordered="false">
    ...
    <div class="operational-scheme-search-wrapper">
      <a-form layout="inline">
        ...
        <template v-if="$auth('ProductInspectionReport:list')">
          <a-form-item>
        ...
        <div class="action-wrapper" style="float: right">
          <a-form-item>
            <template v-if="$auth('ProductInspectionReport:add')">
              <a-button style="margin-left: 8px" type="primary" icon="plus" @click="$refs.modal.add(9)">新增</a-button>
            </template>
            <template v-if="$auth('ProductInspectionReport:list')">
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        <template>
          <template v-if="$auth('ProductInspectionReport:one')">
          ...
          <template v-if="$auth('ProductInspectionReport:edit')">
            <a-divider type="vertical" />
            <a @click="handleEdit(record)">编辑</a>
          </template>
          <template v-if="$auth('ProductInspectionReport:del')">
            <a-divider type="vertical" />
...
import Modal from './modules/ProductInspectionReportModal'
