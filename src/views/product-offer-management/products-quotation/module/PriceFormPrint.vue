    ...
    <a-spin :spinning="spinning">
      <div id="price-print-form-wrapper">
        ...
        <div class="product-main-wrapper add-form__bd-item" :style="borderImageObj">
          <div class="slider-bar" style="flex: 0 0 220px; margin-right: 15px; background-color: #757882;align-items:stretch;">
            <div class="custom_info">
              <div class="custom_info_sell">
                <p class="__ele-english" data-english="quotation party">报价方：</p>
                <p class="__ele-english" data-english="JiangSu Wonderful Infrastructure Manufacturing co.,Ltd">
                  江苏万德福公共设施科技有限公司
                </p>
          ...
          <div class="main-content" style="flex: 1;align-items:stretch;background-color: #f5f5f5;padding:20px;">
            <p
              class="__ele-english"
            ...
            >
              以下为贵公司询价产品明细，请详阅：如有疑问，请及时与我司联系，谢谢！
            </p>
        ...
        <SelectProductViewHTML key="v2" :productInfo="viewDataSourceHTMLWithoutTitle" style="margin-bottom:10px;" />
        <div class="add-form__bd-item" :style="borderImageObj123">
          <p class="__ele-english" data-english="quotation description">报价说明：</p>
          <p class="quotation-html-wrapper" v-html="detail.quoteExplainHTML"></p>
        </div>
      </div>
    </a-spin>
  </a-modal>
    ...
    editAction() {
      ...
      priceAdjustProductQuoteDetail({ id: this.record.id })
        .then((res) => {
          ...
          if (_quoteExplain) {
            that.detail.quoteExplainHTML = _quoteExplain
              .split('\n')
              .map((p) => `<div>${p}</div>`)
              .join('')
          }
