  ...
  <div class="wdf-custom-wrapper">
    ...
    <div class="main-wrapper">
      ...
      >
        ...
        <div slot="holidayUnitType" slot-scope="text, record, index">
          {{ { 1: '按天请假', 3: '按小时请假' }[text] || '未知' }}
        </div>

        <div slot="holidayCaculatorType" slot-scope="text, record, index">
          {{ { 1: '按工作日计算时长', 2: '按自然日计算时长' }[text] || '未知' }}
        </div>
...
<script>
import { holidayRuleList, holidayRuleDel } from '@/api/attendanceManagement'
