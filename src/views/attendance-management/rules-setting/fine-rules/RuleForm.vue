            ...
            <td>
              ...
              <a-form-item>
                <a-input-number
                  ...
                  step="1"
                  style="width: 100%"
                  v-decorator="['num', { rules: [{ required: true, message: '请输入补卡次数' }] }]"
                />
              </a-form-item>
            </td>
          </tr>
...
<script>
import { addAndUpdateFineConfig } from '@/api/attendanceManagement'
// import {
